...
public class XifradorMonoalfabetic implements Xifrador {
    ...
    public XifradorMonoalfabetic() {
        PERMUTADO = permutaAlfabet(ALFABETO);
    }

    // creamos los metodos a implementar
    public TextXifrat xifra(String msg, String key) throws ClauNoSuportada {
        if(key!=null) throw new ClauNoSuportada("Xifratxe monoalfabètic no suporta clau != null");
    ...
    public String desxifra(TextXifrat msg, String key) throws ClauNoSuportada {
        if(key!=null) throw new ClauNoSuportada("Xifratxe monoalfabètic no suporta clau != null");
        String xifrat = new String(msg.getBytes());
        return desxifraMonoAlfa(xifrat);
    }

    // creamos los metodos de cifrado
    public char[] permutaAlfabet(char[] alfa) {
    ...
    public char caracterPermutado(char caracter, char[] alfabeto, char[] permutado) {
